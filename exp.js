...
window.addEventListener('load', function() {
  ...
  const welcomeMessage = "Exploitation involves using the information gathered during reconnaissance to exploit vulnerabilities in the target system or application. Exploitation tools are used to automate the process of finding and exploiting vulnerabilities, such as SQL injection or buffer overflow attacks.";
  let i = 0;
  const typeWriter = () => {
